...
class Products(models.Model):
    ...
    img_1 = models.ImageField(blank=False, default="", upload_to="products/")
    img_2 = models.ImageField(blank=True, default="", upload_to="products/")
    img_3 = models.ImageField(blank=True, default="", upload_to="products/")
